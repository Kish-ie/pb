        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col footer-about">
                    <a href="/" class="footer-logo" aria-label="PBIRT Institute Home">
                        <img src="assets/images/logo-white.svg" alt="PBIRT Institute Logo" width="180" height="60">
                    </a>
                ...
                <div class="footer-col footer-courses">
                    <h3>Our Courses</h3>
                    <ul>
                        <li><a href="/courses/cpa">CPA Program</a></li>
                        <li><a href="/courses/atd">ATD Program</a></li>
                        <li><a href="/courses/cams">CAMS Certificate</a></li>
                        ...
                        <li><a href="/courses/research">Research Methods</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <div class="copyright">
                    &copy; 2023 PBIRT Institute. All Rights Reserved.
                </div>
